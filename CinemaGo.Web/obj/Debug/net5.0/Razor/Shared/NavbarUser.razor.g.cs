#pragma checksum "C:\Users\mukunda\Desktop\New folder\CinemaGo\CinemaGo.Web\Shared\NavbarUser.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "84bcaad1ca41eeaa0b4fdb5e52de581f883091b5"
// <auto-generated/>
...
#nullable disable
    public partial class NavbarUser : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<nav class=""navbar bg-body-tertiary""><div class=""container-fluid""><a class=""navbar-brand"">Navbar</a>
        <form class=""d-flex"" role=""search""><input class=""form-control me-2"" type=""search"" placeholder=""Search"" aria-label=""Search"">
            <button class=""btn btn-outline-success"" type=""submit"">Search</button></form></div></nav>");
        }
